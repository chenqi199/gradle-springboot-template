...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String moduleName = "/@projectName@-management/@projectName@-common";
        projectPath=projectPath+moduleName;

        String finalProjectPath = projectPath;
        FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3306/@projectName@?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&serverTimezone=UTC",
            "root", "1024.")
